...
class ProjectAdmin(TranslationAdmin):
    list_display = ['title_en', 'title_ru', 'title_ky', 'image', 'created', 'description_en', 'description_ru', 'description_ky', 'site_url',
...
class ServiceAdmin(TranslationAdmin):
    list_display = ['image', 'title_en', 'title_ru', 'title_ky']